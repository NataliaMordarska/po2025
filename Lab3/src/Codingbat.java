...
// Możesz dodawać kolejne metody z CodingBat tutaj
// np. public boolean sleepIn(boolean weekday, boolean vacation) { ... }
...
// Tutaj możesz dodać wywołania testowe dla innych metod
    }
}